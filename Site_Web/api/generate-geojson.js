      ...
      features: [
        {
          ...
          properties: {
            ...properties,
            elevation_min: Math.min(...(elevation || [0]).filter(v => v > -100 && v < 5000)),
            elevation_max: Math.max(...(elevation || [0]).filter(v => v > -100 && v < 5000)),
            elevation_mean: elevation ? elevation.filter(v => v > -100 && v < 5000).reduce((a, b) => a + b, 0) / (elevation.filter(v => v > -100 && v < 5000).length || 1) : 0,
